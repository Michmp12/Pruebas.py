...
# Función para limpiar la pantalla antes de mostrar el menú principal o las salidas
def limpiar_menu():
    limpiar_pantalla()
    print("\n--- REGISTRO DE SALIDA ---")
...
def mostrar_salidas():
    limpiar_menu()  # Limpia la pantalla antes de mostrar las salidas
...
# Menú principal para que le pregunte al usuario cuando quiera ingresar o ver las salidas
while True:
    ...
    if opcion == "1":
        ...
        print("Opción no válida. Por favor, seleccione una opción que sí sea válida para hacer el registro.")
